                ...
                switch (g.directionX) {
                    case 'left':
                        this.position.x + this.speed.x + this.parallaxOffsetX <
                            0 && (this.position.x = c - this.parallaxOffsetX)
                        break
                    case 'right':
                        this.position.x + this.speed.x + this.parallaxOffsetX >
                            c && (this.position.x = 0 - this.parallaxOffsetX)
                        break
                    default:
                        ;(this.position.x +
                            this.speed.x +
                ...
                switch (g.directionY) {
                    case 'up':
                        this.position.y + this.speed.y + this.parallaxOffsetY <
                            0 && (this.position.y = e - this.parallaxOffsetY)
                        break
                    case 'down':
                        this.position.y + this.speed.y + this.parallaxOffsetY >
                            e && (this.position.y = 0 - this.parallaxOffsetY)
                        break
                    default:
                        ;(this.position.y +
                            this.speed.y +
                    ...
                    return (
                        this.each(function () {
                            f.data(this, 'plugin_' + e) &&
                                'function' ===
                                    typeof f.data(this, 'plugin_' + e)[c] &&
                                (b = f
                                    .data(this, 'plugin_' + e)
                                    [c].apply(this, g))
                        }),
